            ...
            <Table sx={{ minWidth: 650}} aria-label="simple table">
                ...
                {ProductsList.map((product, index) => (
                    <StyledTableRow key={index}>
                        ...
                        <StyledTableCell align="left">{product[1]}</StyledTableCell>
                        <StyledTableCell>{product[4]}</StyledTableCell>
                        <StyledTableCell>{product[3]}</StyledTableCell>
                        <StyledTableCell>{product[2]}</StyledTableCell>
                        <StyledTableCell align="right">{product[0]}</StyledTableCell>
                    </StyledTableRow>
                ))}
                </TableBody>
            </Table>
